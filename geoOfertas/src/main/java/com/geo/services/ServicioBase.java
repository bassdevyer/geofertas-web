package com.geo.services;
	...
	/**
	 * Servicio que permite realizar operaciones en la BDD, insersi�n,
	 * actualizaci�n, borrado, y busquedas por par�metros para cualquier objeto
	 * persistente.
	 * 
	 * @author Clear Minds Consultores C�a. Ltda.
	 * 
	 * @param <T>
	 *            Entidad sobre la cual se realizar�n las operaciones.
	 */
	public abstract class ServicioBase<T> {
		...
		/**
		 * Busca todos los registros, con l�mite de resultados de acuerdo a los
		 ...
		 * 
		 * @return Lista de objetos con un m�ximo de resultados.
		 */
		...
		/**
		 * 
		 * Realiza una b�squeda de acuerdo a los parametros recibidos, con l�mite de
		 ...
		 *            Hasta que registro queremos los datos.
		 * 
		 * @return Lista de objetos con un m�ximo de resultados que cumple con los
		...
		/**
		 * Realiza una b�squeda de todos los registros, con l�mite de resultados de
		 ...
		 *            Hasta que registro queremos los datos.
		 * 
		 * @return Lista de objetos con un m�ximo de resultados de acuerdo a la
		 *         consulta.
		 */
		...
		/**
		 * Realiza una b�squeda de acuerdo a los parametros recibidos, sin l�mite de
		 * resultados
		 * 
		 * @param consultaJPQL
		 *            Consulta que se desea realizar Ejm: SELECT c FROM Cliente c
		 ...
		 *            Mapa con los parametros y valores Ejm: mapa.put("id", 10)
		 * 
		 * @return Lista de objetos sin un m�ximo de resultados que cumple con los
		 *         par�metros de b�squeda.
		 */
		public List<T> buscar(String consultaJPQL, Map<String, Object> parametros) {
